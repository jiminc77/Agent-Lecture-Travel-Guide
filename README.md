...
고등학생 대상 Agentic AI 강의 자료. 이론 60분 + 실습 90분으로 구성됩니다.
...
- Ubuntu + [opencode](https://opencode.ai) + [K-skill](https://github.com/NomaDamas/k-skill) 사전 설치
- 실습 중 예약 · 결제 · 로그인 · 개인정보 입력은 하지 않습니다 (조회와 비교까지만)
